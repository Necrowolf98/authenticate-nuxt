...
async function handleLogin(isFormValid) {
	...
	<form @submit.prevent="handleLogin(!v$.$invalid)" class="p-fluid">
		<div class="grid grid-flow-row mx-3 gap-3">
			...
			<div class="col-span-12 flex justify-between items-center my-1">
				...
				<NuxtLink class="text-base font-bold text-bluegray-500 hover:text-primary" to="/auth/forgot">&nbsp; &nbsp; Olvidé mi clave!</NuxtLink>
			</div>
			...
			<div class="col-span-12 flex flex-col md:flex-row items-center justify-center mt-3 md:px-0">
				...
				<NuxtLink class="text-base font-bold text-bluegray-500 hover:text-primary" to="/auth/register">&nbsp; &nbsp; Crea una cuenta</NuxtLink>
			</div>
