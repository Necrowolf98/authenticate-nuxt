<template>
  <Transition v-show="isLoading" enter="transition-opacity duration-75" enter-from="opacity-0" enter-to="opacity-100"
    leave="transition-opacity duration-150" leave-from="opacity-100" leave-to="opacity-0">
    <div class="grid place-items-center" :class="[fullHeight ? 'h-screen' : '']">
